#!/usr/bin/env python3
"""Save prospection emails as drafts in Zoho Mail via IMAP."""
...
def main():
    ...
    print(f"Sauvegarde de {len(PROSPECTS)} brouillons...\n")
    saved = 0
    for p in PROSPECTS:
    ...
    imap.logout()
    print(f"\n{saved}/{len(PROSPECTS)} brouillons sauvegardes dans Zoho Mail.")
    print("Va dans Zoho Mail > Brouillons pour les verifier et envoyer.")
